// #define _DEBUG_MODE  //For test purposes, disables data requests and just listen BUS
// #include <SPI.h>
#include <Wire.h>
...
//available screens
enum {NONE, MILEAGE, TEST, BATT, TRIP, MENU, BIG_SPEED, BIG_CURRENT, BIG_AVERAGE, BIG_REMAIN, BIG_MILEAGE, BIG_SPENT, CELLS, CHARGING, NO_BIG, BIG_VOLTS, DEBUG_MODE, BIG_TIME};
//available messages
...
const uint8_t _h2[]    PROGMEM = {0x03, 0x20, 0x01};
...
const char mainMenuItemm1[] PROGMEM = {"RECUP"}; //main menu items
const char mainMenuItemm2[] PROGMEM = {"CRUISE"};
const char mainMenuItemm3[] PROGMEM = {"REAR-LED"};
const char mainMenuItemm4[] PROGMEM = {"BIG DISP"};
const char mainMenuItemm5[] PROGMEM = {"DEBUG"};
...
const char bigMenuItem1[] PROGMEM = {"SPEED"};   //BIG screens list
const char bigMenuItem2[] PROGMEM = {"AVERAGE"};
const char bigMenuItem3[] PROGMEM = {"CURRENT"};
const char bigMenuItem4[] PROGMEM = {"SPENT %"};
const char bigMenuItem5[] PROGMEM = {"MILEAGE"};
const char bigMenuItem6[] PROGMEM = {"VOLTAGE"};
const char bigMenuItem7[] PROGMEM = {"PWR TIME"};
const char bigMenuItem8[] PROGMEM = {"NO BIG"};
...
const char * menuMainItems[]  = {mainMenuItemm1, mainMenuItemm2, mainMenuItemm3, mainMenuItemm4, mainMenuItemm5};
const char * menuRecupItems[] = {rm1, rm2, rm3};
const char * menuOnOffItems[] = {m1,  m2};
const char * menuBigItems[]   = {bigMenuItem1, bigMenuItem2, bigMenuItem3, bigMenuItem4, bigMenuItem5, bigMenuItem6, bigMenuItem7, bigMenuItem8};
